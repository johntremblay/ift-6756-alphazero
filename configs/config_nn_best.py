...
config_main = dotdict({
    ...
    'checkpoint': '/content/drive/MyDrive/az_best_256/',
    'load_model': False,
    'load_folder_file': ('/content/drive/MyDrive/az_best_256/', 'best.pth.tar'),
    'numItersForTrainExamplesHistory': 20,

    'create_log_file': True,
    'log_file_location': f'/content/drive/MyDrive/az_best_256/',
