...
config_main = dotdict({
    ...
    'checkpoint': '/content/drive/MyDrive/AZ_apr5/residual/',
    'load_model': False,
    'load_folder_file': ('/content/drive/MyDrive/AZ_apr5/residual/', 'best.pth.tar'),
    'numItersForTrainExamplesHistory': 20,

    'create_log_file': True,
    'log_file_location': f'/content/drive/MyDrive/AZ_apr5/residual/',
